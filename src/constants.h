...
constexpr SDL_Color CYBER_YELLOW = {255, 212, 2, 255};
...
constexpr SDL_Color BRIGHT_PINK = {255, 0, 127, 255};
...
struct MainMenuConstants {
    ...
    SDL_Color BUTTON_BORDER_COLOR = BRIGHT_GREEN;
    ...
    SDL_Color SANDY_PLAY_BUTTON_COLOR =  OLD_GOLD; //OLD_GOLD
    ...
    SDL_Color SANDY_BUTTON_BORDER_COLOR = YELLOW;
    SDL_Color SANDY_BUTTON_HOVER_COLOR =  BRIGHT_PINK; //BRIGHT_PINK, RETRO_BLUE ?
    SDL_Color SANDY_BUTTON_TEXT_COLOR = WHITE;
